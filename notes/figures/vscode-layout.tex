...
\begin{tikzpicture}[
  ...
  \node[lbl, text width=2.55cm] at (0.78,8.34)
    {{\scriptsize\color{rigMuted} browse and open the project's files}};
  ...
  \node[lbl, text width=8cm] at (3.86,8.68)
    {{\small\bfseries\color{roleEdAcc} File being edited}\ \ {\scriptsize\color{rigMuted} \textbf{Editor} \textemdash{} the file the agent reads and writes}};
  ...
  \node[lbl, text width=3.85cm] at (12.0,8.55)
    {{\scriptsize\color{rigMuted} chat with the agent \textemdash{} it plans, reads, and edits your files}};
  ...
  \fill[roleAgFill, rounded corners=1pt] (12.25,6.58) rectangle (14.45,6.74);
  \fill[roleAgFill, rounded corners=1pt] (12.25,6.32) rectangle (13.95,6.48);
  \node[font=\sffamily\tiny, text=roleAgAcc, anchor=west] at (12.25,6.82) {agent};
  ...
  \fill[roleAgAcc!38, rounded corners=1pt] (13.35,5.16) rectangle (15.6,5.32);
  \fill[roleAgAcc!38, rounded corners=1pt] (13.35,4.90) rectangle (14.9,5.06);
  \node[font=\sffamily\tiny, text=roleAgAcc, anchor=east] at (15.6,5.43) {you};
  % input box
  \draw[rigFrame, line width=0.5pt, rounded corners=3pt] (12.05,2.85) rectangle (15.8,3.55);
  \node[font=\sffamily\scriptsize, text=rigMuted, anchor=west] at (12.2,3.2) {Ask Claude to build, fix, explain\dots};
  ...
  \node[lbl, text width=9cm] at (3.96,2.42)
    {{\small\bfseries\color{white} Shell}\ \ {\scriptsize\color{roleShInk} \textbf{Terminal} \textemdash{} runs commands; the agent's shell output appears here}};
  \node[font=\ttfamily\scriptsize, text=roleShInk, anchor=north west] at (3.7,1.86)
    {\textcolor{roleShCmd}{\$} pytest -q};
  \node[font=\ttfamily\scriptsize, text=roleShInk, anchor=north west] at (3.7,1.56)
    {........\ \ 12 passed in 0.42s};
  \node[font=\ttfamily\scriptsize, text=roleShInk, anchor=north west] at (3.7,1.26)
    {\textcolor{roleShCmd}{\$} python app.py};
  \node[font=\ttfamily\scriptsize, text=roleShInk, anchor=north west] at (3.7,0.96)
    {ready.};
  \node[font=\ttfamily\scriptsize, text=roleShCmd, anchor=north west] at (3.7,0.66)
    {\$ \textcolor{white}{\rule[0.02cm]{0.06cm}{0.22cm}}};
