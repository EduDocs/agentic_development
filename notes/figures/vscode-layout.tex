...
\begin{tikzpicture}[
  ...
  \node[lbl, text width=8cm] at (3.86,8.68)
    {{\small\bfseries\color{roleEdAcc} File being edited}\ \ {\scriptsize\color{rigMuted} \textbf{Editor} \textemdash{} file the agent reads and writes}};
  ...
  \node[lbl, text width=3.85cm] at (12.0,8.55)
    {{\scriptsize\color{rigMuted} chat with agent \textemdash{} it plans, reads, and edits files}};
