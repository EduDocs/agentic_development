...
%%
%% Dual-use file:
%%   • Preview on its own:   pdflatex figures/vscode-layout.tex  (the standalone
%%                           wrapper below activates because TikZ is not yet
%%                           loaded). Run it from the notes/ root, not from
%%                           figures/, so \input{figures/_rig-style} resolves.
