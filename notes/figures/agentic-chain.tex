%% agentic-chain.tex: the lineage as a causal chain (Chapter 1). House conceptual style.
...
%% The milestones are gray (the neutral trunk of the lineage) and the agentic additions
%% blue; the green ramp into `Agents' is a fade, every step lighter than !15.
\input{figures/_concept-style}
\begin{tikzpicture}[
    box/.style={conceptbox, fill=gray!15},
    hbox/.style={conceptbox, fill=white},
    lim/.style={conceptlabel, align=left, text=black!55},
    yr/.style={conceptlabel, text=black!55},
]
...
\draw[conceptflow] (n1) -- (n2);
\draw[conceptflow] (n2) -- (n3);
\draw[conceptflow] (n3) -- (n4);
\draw[conceptflow] (n4) -- (n5);
\draw[conceptflow] (n5) -- (n6);
