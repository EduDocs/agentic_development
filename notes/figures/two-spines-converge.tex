...
\node[conceptbox, fill=green!15] (harness) at (0, 2.0)  {Evaluation\\Harness};
...
\node[conceptbox, fill=green!15]  (fit) at (5.6, 2.0)  {Fitness};
\node[conceptbox, fill=orange!15] (sel) at (8.0, 0.0)  {Select};
