...
\begin{tikzpicture}[
    ...
    conduit/.style={->, >=stealth', line width=1.6pt, roleShAcc},
    reach/.style={->, >=stealth', line width=1.3pt, roleShAcc},
  ]
  ...
  \draw[roleShAcc, line width=1.6pt] (shellL.east) -- (3.5,4.7);   % trunk
  ...
  \draw[->, >=stealth', line width=1.6pt, blockRed] (13.40,5.3) -- (13.52,5.3);
