\begin{tikzpicture}
  ...
  feed/.style={rectangle, minimum height=4mm, minimum width=20mm, rounded corners},
...
\node[draw=black,feed,fill=blue!15] (feed2) at (1.5,3.0) {\tiny Feed Forward};
\node[draw=black,feed,fill=blue!15] (feed1) at (-1.5,3.0) {\tiny Feed Forward};
...
\node[draw=black,circleplus] (cirle2) at (1.5, 0.75) {$+$};
\draw[draw=black,->,line width=0.8pt] (cirle1) to (-1.5,1.4);
\draw[draw=black,->,line width=0.8pt] (cirle2) to (1.5,1.4);
...
\node[draw=black,feed,fill=blue!15] (feed2) at (8.5,3.0) {\tiny Feed Forward};
\node[draw=black,feed,fill=blue!15] (feed1) at (5.5,3.0) {\tiny Feed Forward};
...
\node[circleplus] (cirle3) at (5.5, -0.65) {$+$};
\node[circleplus] (cirle4) at (8.5, -0.65) {$+$};
\draw[->,line width=0.8pt] (cirle3) to (5.5,0.0);
\draw[->,line width=0.8pt] (cirle4) to (8.5,0.0);
\node (posenc) at (7,-0.65) {\scriptsize Positional};
\node (posenc) at (7,-1) {\scriptsize Encoding};
...
\draw [<->] (10.25,5.5) -- (10.25,4) -- (12,4);
\foreach \x in {1,...,5} {
  \draw (10+0.375*\x,3.825) -- (10+0.375*\x,4.125);
  }
\node (tyy1) at (11.125,3.5) {\scriptsize Distribution};
\draw[fill=gray!15,line width=0.5pt] (10.475,4) rectangle (10.65,4.3);
\draw[fill=gray!15,line width=0.5pt] (10.85,4) rectangle (11.025,5);
\draw[fill=gray!15,line width=0.5pt] (11.225,4) rectangle (11.4,4.7);
\draw[fill=gray!15,line width=0.5pt] (11.6,4) rectangle (11.775,4.4);
