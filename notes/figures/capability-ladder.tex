...
\begin{tikzpicture}[
    rung/.style={conceptbox, minimum width=3cm, font=\small},
...
\node[lbl, right=0.6cm of op]  {App, terminal, version control, model API};
\node[lbl, right=0.6cm of bld] {Tool definitions, agent loop, evaluation harness};
