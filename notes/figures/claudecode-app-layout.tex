...
\begin{tikzpicture}[
  ...
  \begin{scope}
    ...
    \fill[rigCanvas] (0.4,1.0) rectangle (3.5,9.25);
    \fill[roleFsFill] (0.4,1.0) rectangle (1.45,9.25);           % Finder sidebar tint
  ...
  \draw[rigSep, line width=0.4pt] (1.45,1.0) -- (1.45,8.75);
  ...
  \node[lbl, text width=3.0cm] at (0.55,8.55)
    {{\small\bfseries\color{roleFsAcc} File system}\ {\scriptsize\color{rigMuted}— Finder}};
  \node[lbl, text width=2.9cm] at (0.55,8.12)
    {{\scriptsize\color{rigMuted} browse your files on disk}};
  % sidebar favourites
  \foreach \i/\t in {0/Recents, 1/Documents, 2/Desktop, 3/Downloads}{
    \node[anchor=west, font=\sffamily\tiny, text=rigMuted] at (0.55,7.6-\i*0.36) {\t};}
  % file list (main pane)
  \foreach \i/\t in {0/{app.py}, 1/{utils.py}, 2/{README.md}, 3/{data.csv}, 4/{figures}}{
    \rigDoc{1.7}{7.62-\i*0.42}{rigMuted}
    \node[anchor=west, font=\ttfamily\tiny, text=rigMuted] at (1.9,7.62-\i*0.42) {\t};}
  ...
  \node[lbl, text width=7.2cm] at (4.1,8.5)
    {{\small\bfseries\color{roleEdAcc} File being edited}\ {\scriptsize\color{rigMuted}— no fixed pane: files open in their default app / a viewer}};
  % faint document preview page (soft — signals "implicit, not a fixed panel")
  \begin{scope}[opacity=0.55]
    \fill[rigCanvas, rounded corners=2pt] (6.15,3.55) rectangle (9.25,7.75);
    \draw[roleEdAcc!55, line width=0.5pt, rounded corners=2pt] (6.15,3.55) rectangle (9.25,7.75);
    \foreach \i/\w in {0/2.4, 1/2.6, 2/1.7, 3/2.6, 4/2.2, 5/2.6, 6/1.3}{
      \fill[roleEdAcc!22, rounded corners=1pt] (6.45,7.25-\i*0.44) rectangle (6.45+\w,7.25-\i*0.44+0.14);}
  \end{scope}
  \node[anchor=north, font=\sffamily\footnotesize\itshape, text=rigMuted] at (7.7,3.45)
    {opens in Preview, TextEdit, a browser\dots\ — whatever owns the file};
  ...
  \node[lbl, text width=3.55cm] at (12.05,8.08)
    {{\scriptsize\color{rigMuted} lives here; drives the other apps}};
  % agent bubble
  ...
  \fill[roleAgFill, rounded corners=1pt] (12.3,6.62) rectangle (14.45,6.78);
  \fill[roleAgFill, rounded corners=1pt] (12.3,6.36) rectangle (14.0,6.52);
  ...
  \fill[roleAgAcc!38, rounded corners=1pt] (13.1,5.32) rectangle (15.3,5.48);
  \fill[roleAgAcc!38, rounded corners=1pt] (13.1,5.06) rectangle (14.6,5.22);
  ...
  \node[font=\sffamily\scriptsize, text=rigMuted, anchor=west] at (12.25,3.6) {Ask Claude\dots};
  ...
  \node[anchor=west, font=\sffamily\scriptsize, text=roleShInk] at (6.05,2.36)
    {{\bfseries\color{white} Shell}\ — Terminal.app: runs commands};
  \node[font=\ttfamily\scriptsize, text=roleShInk, anchor=north west] at (4.15,1.92)
    {\textcolor{roleShCmd}{\$} pandoc notes.md -o notes.pdf};
  \node[font=\ttfamily\scriptsize, text=roleShInk, anchor=north west] at (4.15,1.62)
    {\textcolor{roleShCmd}{\$} python analyze.py};
  \node[font=\ttfamily\scriptsize, text=roleShInk, anchor=north west] at (4.15,1.32)
    {done. \textcolor{white}{\rule[0.02cm]{0.06cm}{0.22cm}}};
