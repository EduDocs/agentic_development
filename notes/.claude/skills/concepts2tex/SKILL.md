...
- User says "concepts2tex", "realize the sidecar", "write up these concepts", "push the .md to .tex".
...
2. **Git-aware age / direction check.** Determine which file changed more recently using:
   ...
   than the sidecar; you may want `/tex2concepts`" — and ask before proceeding.
...
| Wrong-direction guard | git-aware age check; if `.md` older than `.tex`, suggest `/tex2concepts` |
