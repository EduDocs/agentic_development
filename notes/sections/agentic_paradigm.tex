...
A more recent tool type is \emph{computer use}\index{Computer use}: instead of calling a purpose-built API, the model observes a screenshot and issues keyboard and mouse actions, which lets it operate arbitrary desktop software that exposes no programmatic interface (Anthropic, 2024).
