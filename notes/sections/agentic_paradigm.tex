...
It opens by defining the agent and its perceive--reason--act loop; Section~\ref{section:CapabilityLadder} then lays out the four-rung \emph{capability ladder} (operate, build, orchestrate, evolve) that orders the course progerssion; Section~\ref{section:TwoSpines} introduces the two \emph{spines}, evaluation-becomes-fitness and context engineering, that thread every rung; and the closing section asks why general-purpose tool-using models make this the moment the pieces combine.
