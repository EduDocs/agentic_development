...
The course maintains a \emph{baseline ladder}\index{Baseline ladder}: a sequence of methods of increasing sophistication against which each student's system is compared.
