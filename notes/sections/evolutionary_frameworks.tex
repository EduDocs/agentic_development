...
\begin{equation}
\hat{m}^* = \operatorname*{argmin}_{a \in \Artifacts} \Score(a, \mathcal{D}_{\mathrm{val}})
\end{equation}
...
More fundamentally, generation cost is a property of the \emph{path} that produced an artifact, not of the artifact itself --- the same expression can be reached cheaply or expensively --- so folding cost into an artifact's fitness can distort survivor selection.
