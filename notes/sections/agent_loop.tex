...
This decouples capability from model size and adds a knob to the build decision: a fast, low-budget call for routine steps, and a slow, high-budget reasoning pass reserved for the genuinely hard ones.
