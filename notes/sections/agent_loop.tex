...
Frontier \emph{reasoning models}\index{Reasoning model} --- Claude's extended thinking and the o3-class models, to name two families current as of Fall~2026 --- move this step inward, reasoning internally before emitting a tool call, so the thought becomes latent rather than a visible transcript entry.
