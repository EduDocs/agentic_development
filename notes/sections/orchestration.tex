...
Two 2025 studies formalize \emph{what} an agent should keep across runs: \emph{ReasoningBank} distills reusable reasoning strategies from past attempts, and \emph{Agentic Context Engineering} treats the agent's evolving context itself as the artifact to optimize (arXiv:2509.25140; arXiv:2510.04618).
