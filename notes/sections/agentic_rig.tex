...
The model itself runs on the provider's servers; the researcher interacts with it by sending HTTPS/SSH requests containing the context and receiving responses containing the model's output.
