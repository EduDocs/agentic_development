...
A parallel line pre-trained \emph{decoder} models for generation rather than understanding --- the GPT line, from GPT and GPT-2 onward --- and that branch is the one that leads to the models an agent is built from.
