...
The latter branch is the thread that leads to models many  agents are built from.
...
For isntance, \emph{instruction tuning} with human feedback aligned models to follow instructions helpfully rather than merely continue plausible text, making their behavior reliable enough to direct (Ouyang et al., 2022).
