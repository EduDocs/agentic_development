...
Neither was a new idea so much as a new level of a capability the sequence above had been building toward, which is why a legible, incremental progression is so often felt from outside as a sudden arrival.
...
Where they do apply, though, the leverage real; it is not confined to computer science: a biologist fitting population models, an economist searching model specifications, a physicist proposing and testing functional forms, and a chemist screening candidates all face the same well-specified, checkable inner loops.
...
With the timeline in place, the next chapter turns from how we got here to what an agent \emph{is}: the vocabulary and structure the rest of the course builds on.
