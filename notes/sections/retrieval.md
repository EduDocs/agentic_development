...
- 2026-07-11 (realized in prose, engineering-blog pass, visual): added `figure:RetrievalStaircase` — retrieval failure rate falling in stackable increments (contextual embeddings, then keyword, then rerank; ~1/3, 1/2, 2/3), cited at the composable-reductions sentence; ties Ch.7 quality to the Ch.6 evaluation mindset. Numbers hedged as benchmark-specific.
<!-- EVOLVE-BLOCK-END -->
